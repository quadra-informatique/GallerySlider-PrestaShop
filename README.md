# GallerySlider for PrestaShop

This PrestaShop module allows you to add a slider on the homepage with thumbnails as scrolling buttons on the right or in the bottom
